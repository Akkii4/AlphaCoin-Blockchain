...
const currentNodeUrl="http://localhost:"+process.env.port;	//url of current node we are fetching port from what we are entering in node eg:port=3002 npm start =>http://localhost:3002 & if we dont pass any port eg.npm start =>http://localhost:3001
